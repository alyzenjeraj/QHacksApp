    ...
    return (
        <View>
            ...
            <Swipeable overshootRight={true} onSwipeableRightOpen={changeScreen} renderRightActions={RenderRight} renderLeftActions = {RenderLeft} onSwipeableLeftOpen={changeScreen} >
             <Text
            style={styles.texted}>Jenny</Text>
            <View style={{flexDirection: 'row', justifyContent: 'center', }}>
            <Image
            style={styles.image}
            source={require('../assets/crochet.jpg')}/>
            </View>
            <Text style={styles.textNorm}>Skill: Crochet</Text>
            <Text style={styles.textNorm}>Timeline: 1 month</Text>
            <Text style={styles.textNorm}>Projects completed: 1</Text>
            <Text style={styles.textNorm}>Socials: @bc789</Text>
        </Swipeable>
        </View>
